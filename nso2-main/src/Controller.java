...
public final class Controller implements IMessageHandler {
	...
	public final void onMessage(Message msg) {
		ActivityQuickClaim.normalizeIncomingMessage(msg);
		try {
			GameScr var22 = null;
			byte var2;
			int var3;
			...
			case 93:
				...
				if (GameScr.currentCharViewInfo == Char.getMyChar()) {
					DailyCharacterProgress.onServerSnapshot();
				}
