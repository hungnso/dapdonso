public final class AutoDanhVong extends Auto {
   ...
   public static void onTaskPopup(String title, String content) {
      ...
      // Controller case 53 is only one of the ways the client can display the
      // reputation popup. Cache here, while GameScr.a(...) performs the active
      // parse exactly once for every visible alert.
      saveCachedQuest(title, content);
